  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columns1 : [
        ...
        { title: 'Vacaciones', field: 'vacaciones'},
        ],
        data1 : [
        { clave: '1', curso: 'Excel', 
        ...
        <div  className="root">
            ...
            <Paper className={classes.root}>
              <div style={{display:'flex',width:'100%',height:'50%'}}>
                <div style={{width:'69%',height:'100%',borderStyle:'solid',color:'rgb(220, 215, 215)',borderTopColor:' #00AFA9',marginRight:'2%'}}>
                <TableDecored
            addButton={false}
            Allactions={true}
          ...
          />
                ...
                <div style={{width:'29%',height:'100%',borderStyle:'solid',color:'rgb(220, 215, 215)',borderTopColor:' blue'}}>
                <TableDecored
            addButton={false}
            Allactions={true}
          ...
          />
              ...
              <div style={{display:'flex',width:'100%',height:'50%',marginTop:'2%'}}>
