    ...
    <div>
      ...
      <ParentPopupState.Provider value={Presupuestos}>
        ...
        >
          ...
          <MenuItem
            onClick={() => {
              Presupuestos.close;
              props.history.push("/holidayscatalog");
            }}
          >
            Catalogo - Vacaciones
          </MenuItem>
          {/* <MenuItem onClick={Presupuestos.close}>Estudios</MenuItem> */}
        </Menu>
      ...
      <ListItem button {...bindTrigger(popupState)}>
        <div>
          ...
          >
            <StarBorder className={classes.iconStyle} />
          </ListItemIcon>
        </div>
        <ListItemText
          primary="Presupuesto"
      ...
      <ParentPopupState.Provider value={popupState}>
        ...
        >
          ...
          {/* <MenuItem onClick={popupState.close}>Estudios</MenuItem> */}
        </Menu>
      </ParentPopupState.Provider>
      ...
      <ListItem button>
        ...
        >
          <DraftsIcon className={classes.iconStyle} />
        </ListItemIcon>
        <ListItemText
          primary="Drafts"
          classes={{ primary: classes.listItemText }}
      ...
      <ListItem button {...bindHover(popupState2)}>
        <ListItemIcon
          style={
            props.open === false
              ? { color: "#848484" }
